import { func1 } from 'nueip/example/utils.js';
// main.js
import Car from 'nueip/attendance-record/Car.js';
import Selector from 'nueip/attendance-record/selector.js';
...
describe('My Test Suite', () => {
  ...
  it.only('My Test Case', () => {
    ...
    // cy.log(myCar.present());  // Output: "I have a Ford"
  ...
  it('My Attendance', () => {
    // 前往出勤記錄
    cy.visit('https://mars8-cloud.rd1.nueip.site/attendance_record');
